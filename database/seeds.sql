...
--   (titre, description, type_logement, prix, type_prix, surface, nb_pieces, nb_chambres, nb_salles_bain, ville, quartier, adresse, latitude, longitude, meuble, climatise, parking, gardiennage, eau_courante, groupe_electro, piscine, est_publie, cree_par)
-- VALUES
--   ('Appartement Terra', 'Studio moderne en centre-ville.', 'studio', 250000.00, 'mois', 35.00, 2, 1, 1, 'Cotonou', 'Quartier Central', 'Rue du Marché 12', 6.3700, 2.4263, 1, 1, 1, 0, 1, 0, 0, 1, 1);
